    ...
    return (
        <section class="bg-slate-300 h-screen">
            <section class="flex font-sans items-center justify-center gap-24 m-auto py-32 max-md:flex-wrap-reverse ">
                ...
                <div>
                    <img class="h-60 w-60 border-8 shadow-[0_20px_80px_5px_rgba(0,0,0,0.3)] shadow-yellow-400 hover:shadow-red-400 border-solid border-yellow-400 rounded-full mt-6 max-md:mt-4" src="/image/pic-design.png" ></img>
                </div>
            </section>
        </section>
    )
